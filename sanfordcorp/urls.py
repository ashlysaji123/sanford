...
urlpatterns = (
    [
        ...
        path("api/v1/merchandiser/", include("api.v1.merchandiser.urls", namespace="api_v1_merchandiser")),
        ...
        path("api/v1/rewards/", include("api.v1.rewards.urls", namespace="api_v1_rewards")),
