...
class RegionForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            "name": TextInput(
                attrs={"class": "required form-control", "placeholder": "Region Name"}
            ),
        }
...
class LanguageForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            "family": TextInput(
                attrs={"class": "required form-control", "placeholder": "Family"}
            ),
            "name": TextInput(
                attrs={"class": "required form-control", "placeholder": " Name"}
            ),
            "native_name": TextInput(
                attrs={"class": " form-control", "placeholder": "Native Name"}
            ),
            "lang_code": TextInput(
                attrs={"class": " form-control", "placeholder": "Language code"}
            ),
        }
...
class CountryForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            "country_code": TextInput(
                attrs={"class": "required form-control", "placeholder": "Country code"}
            ),
...
class StateForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            "state_code": TextInput(
                attrs={"class": "form-control", "placeholder": "State code"}
            ),
            "tin_number": TextInput(
