...
urlpatterns = [
    ...
    re_path(
        r"^update-language/(?P<pk>.*)/", views.update_language, name="update_language"
    ),
    re_path(
        r"^delete-language/(?P<pk>.*)/", views.delete_language, name="delete_language"
    ),
    # country
    path("add-country", views.add_country, name="add_country"),
    path("country-list", views.country_list, name="country_list"),
    re_path(
        r"^update-country/(?P<pk>.*)/", views.update_country, name="update_country"
    ),
    re_path(
        r"^delete-country/(?P<pk>.*)/", views.delete_country, name="delete_country"
    ),
    # State
