...
class CategoryForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'code' :TextInput(attrs={'class': 'required form-control', 'placeholder': 'Category Code'}),
        }
...
class SubCategoryForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'name' :TextInput(attrs={'class': 'required form-control', 'placeholder': 'Sub Category Name'}),
            'code' :TextInput(attrs={'class': 'required form-control', 'placeholder': 'ub Category Code'}),
        }
...
class ProductForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            'name' :TextInput(attrs={'class': 'required form-control', 'placeholder': 'Product name'}),
            'barcode' :TextInput(attrs={'class': 'required form-control', 'placeholder': 'Barcode'}),
            'item_number' :TextInput(attrs={'class': 'required form-control', 'placeholder': 'Item number'}),
            'summary' :Textarea(attrs={'class': ' form-control', 'placeholder': 'Summary'}),
            'group': Select(attrs={'class': 'required form-control tt-select2'}),
            'subcategory': Select(attrs={'class': 'required form-control tt-select2'}),
            'list_price': TextInput(attrs={'class': 'required form-control', 'placeholder': 'List price'}),
