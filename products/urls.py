...
urlpatterns = [
    ...
    re_path(
        r"^update-product_category/(?P<pk>.*)/",
        views.update_product_category,
        name="update_product_category",
    ),
    re_path(
        r"^delete-product_category/(?P<pk>.*)/",
    ...
    re_path(
        r"^update-product_sub_category/(?P<pk>.*)/",
        views.update_product_sub_category,
        name="update_product_sub_category",
    ),
    re_path(
        r"^delete-product_sub_category/(?P<pk>.*)/",
    ...
    re_path(
        r"^update-product_group/(?P<pk>.*)/",
        views.update_product_group,
        name="update_product_group",
    ),
    re_path(
        r"^delete-product_group/(?P<pk>.*)/",
    ...
    re_path(
        r"^single-product/(?P<pk>.*)/", views.product_single, name="product_single"
    ),
    re_path(
        r"^update-product/(?P<pk>.*)/", views.update_product, name="update_product"
    ),
    re_path(
        r"^delete-product/(?P<pk>.*)/", views.delete_product, name="delete_product"
    ),
]
