    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('GUEST', 'GUEST'), ('MERCHANT', 'MERCHANT'), ('SALES_EXECUTIVE', 'SALES_EXECUTIVE'), ('SALES_COORDINATOR', 'SALES_COORDINATOR'), ('SALES_MANAGER', 'SALES_MANAGER')], default='GUEST', max_length=255)),
                ('is_sales_manager', models.BooleanField(default=False)),
                ('is_sales_coordinator', models.BooleanField(default=False)),
                ('is_sales_exicutive', models.BooleanField(default=False)),
